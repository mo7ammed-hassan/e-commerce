...
abstract class ProductRepository {
  ...
  // --get all prodcuts--
  Future<Either<dynamic, List<ProductEntity>>> getAllFeaturedProducts({required int limit});
  Future<Either<dynamic, List<ProductEntity>>> getAllPopularProducts({required int limit});
